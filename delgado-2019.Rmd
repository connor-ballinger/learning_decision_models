...
a_costs[rownames(m_cost_neo_pp), colnames(m_cost_neo_pp), "0"] <- 
  a_costs[rownames(m_cost_neo_pp), colnames(m_cost_neo_pp), "0"] +
  (m_cost_neo_pp %*% diag(a_trace_semi["Stable", colnames(m_cost_neo_pp), "0", "0"])) * 3
...
1:3 |> 
  walk(\(x) a_costs[rownames(m_cost_neo_pp), colnames(m_cost_neo_pp), x] <<- 
         ...
         m_cost_neo_pp %*% diag(rowSums(a_trace_semi["Stable", colnames(m_cost_neo_pp), x, ], na.rm = TRUE))
  )
...
1:6 |> 
  walk(\(x) a_costs[, , x] <<- 
         a_costs[, , x] +
         m_cost_adjuvant %*% diag(rowSums(a_trace_semi["Stable", , x, ], na.rm = TRUE))
  )
