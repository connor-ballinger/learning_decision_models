...
-   Optionally, use population figures instead of existing probability (would require adding yearly cohort with pop growth too). Also, could add costs. Probably not worth it?
