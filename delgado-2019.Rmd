...
df_prob[, c("cycle", "prob_s_p", "prob_s_d", "prob_p_d")]
...
a_prob["Stable", "Progressed", "I", ] <- as.vector(df_prob_stages[[1]][, "prob_s_p"]) # this is not a vector for some reason.


a_prob[, , , "0"]

list(v_names_stages, 0:n_cycles) |> 
  pmap(\(x, y) a_prob["Stable", "Progressed", x, y] = df_prob[df_prob$stage == x & df_prob$cycle == y, "prob_s_p"])
```
